...
const Profile = () => {
  ...
  const [themes, setThemes] = useState([
    ...
    },
    {
      title: 'Géométrie',
      color: green,
      icon: <Svg width="51" height="51" viewBox="0 0 51 51" fill="none">
        <Circle cx="25.5" cy="25.5" r="25" fill="white" />
        <G transform="translate(10, 10) scale(1.3)">
          <Path d="M28.4173 28.4168L2.58398 2.5835V28.4168H28.4173Z" stroke="#34AD6A" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
          <Path d="M8.39648 22.6045H16.1465L8.39648 14.8545V22.6045Z" stroke="#34AD6A" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
          <Path d="M19.3757 28.4167V26.4792M15.5007 28.4167V26.4792M11.6257 28.4167V26.4792M7.75065 28.4167V26.4792M2.58398 23.25H4.52148M2.58398 19.375H4.52148M2.58398 15.5H4.52148M2.58398 11.625H4.52148" stroke="#34AD6A" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
        </G>
      </Svg>,
      isSelected: false
    }
