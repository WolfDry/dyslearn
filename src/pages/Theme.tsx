...
const Theme = ({ route }) => {
  ...
  return (
    <View style={[styles.justifyContentBetween, styles.flex_1, styles.alignItemsStart, styles.bg_cream]}>
      <View style={[styles.flex_1, styles.alignSelfStrech, styles.gap_50, styles.alignItems, styles.padding_50, styles.flexRow]}>
        <View style={[styles.center, style.reddContainer]}>
          ...
          <Image style={[styles.alignSelfStrech, style.image]} source={path.image} resizeMode='contain' />
        </View>
