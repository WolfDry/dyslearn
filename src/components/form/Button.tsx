...
const Button = (props: ButtonProps) => {
    ...
    return (
      <Shadow distance={15} startColor='rgba(2, 52, 54, 0.20)' offset={[10, 10]}>
        ...
        >
          ...
          <CustomText style={[style.returnText, styles.cream, styles.black]}>
            {props.text}
          </CustomText>
        </Pressable>
      </Shadow>
  ...
  return (
    ...
    <Pressable style={[
      ...
      props.isStrech ? styles.alignSelfStrech : null
    ]}
      onPress={props.action}
    >
      <CustomText style={[style.text, styles.cream, styles.black]}>
        {props.text}
      </CustomText>
    </Pressable>
    // </Shadow>
